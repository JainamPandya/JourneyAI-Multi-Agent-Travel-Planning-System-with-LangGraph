# ✈️ JOURNEY AI — A Multi-Agent Travel Planner with MCP

An open-source AI travel planner that turns a natural-language trip request into a practical travel plan with flight suggestions, hotel ideas, weather details, and a day-by-day itinerary. The project uses a multi-agent Agentic AI workflow built with LangGraph and LangChain, with MCP used to standardize tool integrations.
