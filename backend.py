...
# A single background event loop that stays alive for the
# entire process.  Sync LangGraph nodes submit coroutines
# to it via run_async() instead of asyncio.run(), which
# would create and destroy a new loop every time and break
